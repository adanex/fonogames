...
<html>
		...
		<div id="fh5co-contact">
			...
			<div class="row animate-box">
				...
				<div class="col-md-6 col-md-offset-3  fh5co-heading" id="div_centro">
					<h2>El juego consiste en escribir abajo de las imagenes el numero correcto de silabas despues de haberle escrito lo que creas que es correcto deberas presionar enter y si es correcta sonara.</h2>
					<p>Si requieres ayuda click a la imagen y luego al botos pistas donde sonaran aplausos dependiendo de lo que hay en la imagen.</p>
					<center >
				...
				<div class="col-md-6 col-md-offset-3 text-center fh5co-heading">
					...
					<div class="row">
						...
						<div id="imagenes" class="contenedor">
								<canvas class="estilo_imagen" id="ojo" ></canvas>
								<canvas class="estilo_imagen" id="sal" ></canvas>
								
								
								<canvas class="estilo_imagen" id="casa" ></canvas>
								<canvas class="estilo_imagen" id="hoja" ></canvas>
						...
						<div id="tabla" class="contenedor" >
								<canvas class="estilo_imagen" id="tijeras" ></canvas>
								<canvas class="estilo_imagen" id="silla" ></canvas>
								<canvas class="estilo_imagen" id="nube" ></canvas>
								<canvas class="estilo_imagen" id="lentes" ></canvas>
	...
	<script text="text/javascript" id="identificador" src="js/juego2.js" ></script>
