...
<html>
		...
		<div id="fh5co-contact">
			...
			<div class="row animate-box">
				...
				<div class="col-md-6 col-md-offset-3  fh5co-heading" id="div_centro">
					<h2>El juego consiste en arrastras las imagenes de la izquierda hacia la imagen donde la primer silaba sea la misma.</h2>
	...
	<script text="text/javascript" id="identificador" src="js/juego3.js" ></script>
