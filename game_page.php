		...
		<div id="fh5co-contact">
			...
			<div class="row animate-box">
				...
				<div class="col-md-6 col-md-offset-3  fh5co-heading" id="div_centro">
					<h2>El juego consiste en arrastras las imagenes en la columna correcta dependiendo de el numero de silabas</h2>
			...
			<center>
				<div>
					<progress value="0" max="60" id="progreso">  </progress>
				</div>
			</center>
				...
				<div class="col-md-6 col-md-offset-3 text-center fh5co-heading">
					...
					<div class="row">
						...
						<div id="imagenes" class="contenedor">
								<canvas class="estilo_imagen" id="gato" onmousedown="dragStart(event)"></canvas>
								<canvas class="estilo_imagen" id="libro" onmousedown="dragStart(event)" ></canvas>
								<canvas class="estilo_imagen" id="pelota" onmousedown="dragStart(event)" ></canvas>
								<canvas class="estilo_imagen" id="pan" onmousedown="dragStart(event)"></canvas>
								<canvas class="estilo_imagen" id="pescado" onmousedown="dragStart(event)" ></canvas>
								<canvas class="estilo_imagen" id="carro" onmousedown="dragStart(event)" ></canvas>
						</div>

						<div id="tabla" class="contenedor" >
							<div id="silaba1" class="silabas" style="background-color: rgb(165,244,191); height: 200px;" >1 silaba</div>
							<div id="silaba2" class="silabas" style="background-color: rgb(165,244,191); height: 200px">2 silabas</div>
							<div id="silaba3" class="silabas" style="background-color: rgb(165,244,191); height: 200px;">3 silabas</div>
						</div>
					</div>
					</center>
				</div>
