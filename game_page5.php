		...
		<div id="fh5co-contact">
			...
			<div class="row animate-box">
				...
				<div class="col-md-6 col-md-offset-3  fh5co-heading" id="div_centro">
					<h2>El juego consiste en arrastras las imagenes hacia la columna donde encuentren la primer letra que coinsida de la palabra</h2>
...
<center>
				...
				<div class="col-md-6 col-md-offset-3 text-center fh5co-heading">
					...
					<div class="row">
						...
						<div id="tabla" class="contenedor" >
								<div id="m" class="silabas" style="background-color: rgb(250,183,109); height: 200px;" >M</div>
			
								<div id="p" class="silabas" style="background-color: rgb(250,183,109); height: 200px;">P</div>
			
								<div id="l" class="silabas" style="background-color: rgb(250,183,109); height: 200px;">L</div>
			
								<div id="s" class="silabas" style="background-color: rgb(250,183,109); height: 200px;">S</div>
			
								<div id="d" class="silabas" style="background-color: rgb(250,183,109); height: 200px;">D</div>
						</div>
					</div>
					</center>
				</div>
	...
	<script text="text/javascript" id="identificador" src="js/juego5.js" ></script>
