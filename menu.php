<?php 
	...
	$Lquery="SELECT nombre FROM usuarios 
					...
					<div class="row">
						...
						<div class="col-md-12">
							...
							<div class="form-group">
								<a href="game_page.php" class="btn btn-primary btn-modify"> Jugar</a>
								
							</div>
						</div>
						<div class="col-md-12">
							<div class="form-group">
								<a href="avance.php" class="btn btn-primary btn-modify"> Avances</a>
								
							</div>
						</div>
						<div class="col-md-12">
							<div class="form-group">
								<a href="configuracion.php" class="btn btn-primary btn-modify"> Configuracion</a>
								
							</div>
						</div>
						<div class="col-md-12">
							<div class="form-group">
								<a href="cersec.php" class="btn btn-primary btn-modify"> Salir</a>
