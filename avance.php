<?php 
	...
	$Lquery="SELECT id,nombre FROM usuarios 
		...
		<div id="fh5co-contact">
			<div class="row animate-box">
				<div class="col-md-6 col-md-offset-3 text-center fh5co-heading">
					...
					<p>Como has estado estos son tus registros de avances</p>
				</div>
			</div>
			<div class="row">
				<div class="col-md-6 col-md-offset-3 text-center fh5co-heading">
					...
					<div class="row">
						...
						<?php 
							$Aquery="SELECT datos FROM avance 
							WHERE id_usuario =".$Lconsultado['id'] ;
							
							$Aconsulta=$conexion -> query($Aquery);
							

							while ($mostrar=mysqli_fetch_array($Aconsulta)) {
								?>
								<tr>
									<th><?php echo $mostrar['datos']; ?></th>
